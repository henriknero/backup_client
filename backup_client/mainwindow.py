...
from backup_client.network import get_reponame_from_path, is_repo
...
class Root(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.monitored_folders.Bind(wx.EVT_RIGHT_DOWN, self.right_click_event)
    ...
    def remove_folder_git(self, event):
        ...
        try:
            ...
            logger.warning(" Repository %s was not found on remote server", repo_name)
...
class Mainwindow(wx.App):
    def OnInit(self):
        ...
        self.frame.Show()
        return True
    def set_gitgogs(self, gitgogs):
        self.frame.gitgogs = gitgogs
        self.frame.load_stored_patterns()
    def create_taskbaricon(self, icon):
